...
def strerror(errno: Optional[int] = None) -> str: ...
def zmq_errno() -> int: ...
def zmq_version() -> str: ...
def zmq_version_info() -> Tuple[int, int, int]: ...
def zmq_poll(sockets: List[Any], timeout: Optional[int] = None): ...
def device(device_type: int, frontend: Socket, backend: Optional[Socket] = None): ...
